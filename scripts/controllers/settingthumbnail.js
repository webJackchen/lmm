...
/**
 * @ngdoc function
 * @name lanhKdesignApp.controller:SettingthumbnailCtrl
 * @description
 * # SettingthumbnailCtrl
 * Controller of the lanhKdesignApp
 */
angular.module('lanhKdesignApp')
  .controller('SettingthumbnailCtrl', ['$scope', '$element', '$http', '$timeout',
      function ($scope, $element, $http, $timeout) {
          ...
          $scope.applySetting = function () {
              $scope.$parent.$broadcast("framework.setting." + $scope.controlId, {
                  data: $scope.data,
                  template: $scope.template, style: $scope.style
              });
