...
/**
 * @ngdoc function
 * @name lanhKdesignApp.controller:SettingGoodsCategoryListCtrl
 * @description
 * # SettingimageCtrl
 * Controller of the lanhKdesignApp
 */
angular.module('lanhKdesignApp')
  .controller('SettingGoodsCategoryListCtrl', ["$scope", "$element", "baseService", "$filter","$timeout","utilsService",
function ($scope, $element, baseService, $filter, $timeout, utilsService) {
        ...
        /*递归遍历数据集，设置数据项的历史选择状态*/
          ...
          var getSelectedCategory = function (callback) {
              ...
              $scope.data.selectedCategoies = resultItems;
              $timeout(function () {
                  callback();
              });
          }
